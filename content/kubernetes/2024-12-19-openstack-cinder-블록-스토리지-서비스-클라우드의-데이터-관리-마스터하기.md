+++
title = "OpenStack Cinder — 클라우드 VM에 붙이는 가상 하드디스크"
date = "2024-12-19"
description = "Cinder는 OpenStack에서 VM에 연결하는 영구 블록 스토리지를 제공한다. VM을 꺼도 데이터가 사라지지 않는다."
tags = ["kubernetes"]
...
**Cinder는 VM과 독립적으로 존재하는 영구 블록 스토리지를 API로 관리한다.**
