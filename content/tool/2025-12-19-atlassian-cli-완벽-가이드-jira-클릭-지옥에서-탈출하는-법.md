+++
title = "Atlassian CLI: Jira 반복 작업을 터미널에서 자동화하는 법"
date = "2025-12-19"
description = "Atlassian 공식 CLI(ACLI)는 Jira Cloud의 이슈 생성, 상태 변경, 대량 수정을 명령줄 한 줄로 처리하며, 2025년 5월부터 모든 Jira Cloud 플랜에 무료로 포함됐다."
tags = ["tool"]
categories = ["tool"]
draft = false
ShowToc = true
