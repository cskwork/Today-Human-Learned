+++
title = "Context Compression — AI 코딩 도구가 긴 코드를 잊지 않는 방법"
date = "2025-06-05"
description = "LLM은 컨텍스트 창이 가득 차면 중간 내용을 잊는다. Context Compression은 이 문제를 해결하기 위해 코드와 문서를 압축해서 핵심만 남기는 기술이다."
tags = ["ai"]
categories = ["ai"]
draft = false
ShowToc = true
