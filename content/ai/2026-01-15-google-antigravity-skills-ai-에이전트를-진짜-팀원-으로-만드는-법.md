+++
title = "Google Antigravity Agent Skills — AI 에이전트를 진짜 팀원으로 만드는 법"
date = "2026-01-15"
description = "SKILL.md 파일 하나로 AI 에이전트에게 팀의 작업 규칙을 학습시키는 오픈 표준이다. 한 번 정의하면 Claude Code, Gemini CLI, Open Code에서 동일하게 작동한다."
tags = ["ai"]
categories = ["ai"]
draft = false
ShowToc = true
