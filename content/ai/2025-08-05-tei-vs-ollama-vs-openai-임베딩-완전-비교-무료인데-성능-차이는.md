+++
title = "TEI vs Ollama vs OpenAI 임베딩 비교 — 로컬 무료가 두 개라면?"
date = "2025-08-05"
description = "TEI와 Ollama 모두 로컬에서 무료로 쓸 수 있다. 차이는 성능(TEI)이냐 편의성(Ollama)이냐이고, OpenAI는 즉시 쓸 수 있는 유료 클라우드 옵션이다."
tags = ["ai"]
categories = ["ai"]
draft = false
ShowToc = true
