+++
title = "Composio MCP 서버를 Claude Desktop에 연결하기"
date = "2025-03-08"
description = "Composio의 MCP 서버를 `claude_desktop_config.json`에 등록하면 Claude가 Gmail, Notion, GitHub 등 250개 이상의 외부 서비스를 직접 다룰 수 있다."
tags = ["ai"]
categories = ["ai"]
draft = false
ShowToc = true
