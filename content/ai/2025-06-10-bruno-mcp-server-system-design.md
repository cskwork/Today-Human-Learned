+++
title = "Bruno MCP Server — LLM에게 API 테스트 능력을 붙이는 어댑터"
date = "2025-06-10"
description = "Bruno MCP Server는 AI 에이전트가 Bruno CLI를 통해 API 컬렉션을 실행하거나 테스트 코드를 생성할 수 있도록 중간에서 연결해주는 얇은 어댑터다."
tags = ["ai"]
categories = ["ai"]
draft = false
ShowToc = true
