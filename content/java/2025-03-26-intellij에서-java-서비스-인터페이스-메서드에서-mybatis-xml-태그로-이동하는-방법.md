+++
title = "IntelliJ에서 Java 인터페이스 메서드에서 MyBatis XML 태그로 이동하기"
date = "2025-03-26"
description = "MyBatis 플러그인(Free MyBatis Plugin 또는 MyBatisX)을 설치하면 인터페이스 메서드와 XML 쿼리 사이를 클릭 한 번에 오갈 수 있다."
tags = ["java"]
categories = ["java"]
draft = false
ShowToc = true
