+++
title = "Spring Batch Step과 Status — 배치 흐름 제어의 기초"
date = "2024-11-07"
description = "Spring Batch의 Job은 여러 Step으로 나뉘고, 각 Step은 BatchStatus로 실행 상태를 기록한다. Status 값에 따라 다음 Step으로 갈지, 복구 경로로 갈지를 선언적으로 제어할 수 있다."
tags = ["java"]
categories = ["java"]
draft = false
ShowToc = true
