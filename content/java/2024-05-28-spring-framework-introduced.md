...
date = "2024-05-28"
description = "Spring은 의존성 주입(DI)과 관점 지향 프로그래밍(AOP)을 핵심으로, Java 앱의 객체 관리와 횡단 관심사를 프레임워크가 담당하는 도구 모음이다."
tags = ["java"]
categories = ["java"]
draft = false
ShowToc = true
...
> **TL;DR**
> Spring은 의존성 주입(DI)과 관점 지향 프로그래밍(AOP)을 핵심으로, Java 앱의 객체 관리와 횡단 관심사를 프레임워크가 담당하는 도구 모음이다.
...
| Spring Boot | 설정 최소화 + 내장 서버로 Spring 앱을 빠르게 시작할 수 있는 래퍼 |
