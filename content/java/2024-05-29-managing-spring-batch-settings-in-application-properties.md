+++
title = "Spring Batch 설정을 application.properties로 관리하는 법"
date = "2024-05-29"
description = "`application.properties` 하나에 Spring Batch의 DB 연결, 실행 여부, 재시도 횟수를 모아두면 코드 수정 없이 환경마다 배치 동작을 바꿀 수 있다."
tags = ["java"]
categories = ["java"]
draft = false
ShowToc = true
