+++
title = "AutoCodeRover — AI가 GitHub 이슈를 읽고 코드를 고쳐주는 도구"
date = "2024-06-24"
description = "AutoCodeRover는 GitHub 이슈를 입력받아 LLM이 코드베이스를 탐색하고 패치를 생성하는 자동화 도구다. Docker로 설치하고 API 키만 있으면 로컬에서 실행할 수 있다."
tags = ["concept"]
categories = ["concept"]
draft = false
ShowToc = true
