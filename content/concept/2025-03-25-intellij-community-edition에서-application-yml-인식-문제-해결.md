+++
title = "IntelliJ Community Edition에서 application.yml이 로드되지 않는 문제"
date = "2025-03-25"
description = "IntelliJ Community Edition으로 Spring Boot를 실행하면 활성 프로파일이 지정되지 않아 application.yml을 못 읽는 경우가 있으며, Run Configuration에서 환경 변수 한 줄로 해결된다."
tags = ["concept"]
categories = ["concept"]
draft = false
ShowToc = true
