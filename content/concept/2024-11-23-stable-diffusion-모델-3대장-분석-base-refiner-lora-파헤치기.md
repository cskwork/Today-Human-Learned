+++
title = "Stable Diffusion 모델 3종 정리 — Base, Refiner, LoRA의 역할 구분"
date = "2024-11-23"
description = "Base Model이 이미지 전체 구조를 잡고, LoRA가 원하는 스타일을 주입하고, Refiner가 마지막 디테일을 다듬는다. 세 가지는 교체 가능한 부품처럼 조합해서 쓴다."
tags = ["concept"]
categories = ["concept"]
draft = false
ShowToc = true
