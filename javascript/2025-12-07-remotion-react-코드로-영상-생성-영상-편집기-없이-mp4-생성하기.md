# Remotion: React 코드로 영상 생성, 영상 편집기 없이 MP4 만들기
...
영상 편집 도구는 반복 작업에 약하다. 100명에게 각자 이름이 들어간 맞춤 영상을 보내려면 100번 직접 편집해야 한다. API 데이터를 받아 실시간으로 영상을 생성하는 것도 기존 편집 소프트웨어로는 불가능하다.
